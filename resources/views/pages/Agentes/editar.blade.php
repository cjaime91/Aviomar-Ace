                ...
                <div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-3">
                    <div class="widget-box widget-color-orange" id="widget-box-3">
                        <div class="widget-header widget-header-small">
                            <h2 class="widget-title">Editar Agente</h2>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                ...
                                <div class="card card-info">
                                    <form action="{{ route('actualizar_agente', ['id' => $agente->agente_id]) }}"
                                        id="form-general" class="form-horizontal form--label-right" method="POST"
                                        autocomplete="off">
                                        @csrf @method("put")
                                        <div class="card-body">
                                            @include('pages.Agentes.form_editar')
                                        </div>
                                    </form>
                                </div>
