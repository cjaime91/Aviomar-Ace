...
@section('scripts')
    <script src="{{ asset('assets/js/crear_cotizacion.js') }}" type="text/javascript"></script>
    ...
    <script>
        ...
        function PaisSelect_or() {
            $.ajax({
                ...
                success: function(response) {
                    pais_or.empty();
                    pais_or.append('<option value="">--Seleccione--</option>')
        ...
        function PaisSelect_ds() {
            $.ajax({
                ...
                success: function(response) {
                    pais_ds.empty();
                    pais_ds.append('<option value="">--Seleccione--</option>')
                    $.each(response.data, function(key, value) {
                ...
                <div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-3">
                    <div class="widget-box widget-color-orange" id="widget-box-3">
                        <div class="widget-header widget-header-small">
                            <h2 class="widget-title">Nueva Cotización</h2>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <br>
                                <form action="{{ route('guardar_cotizacion') }}" id="form-general"
                                    class="form-horizontal" method="POST" onsubmit="return checkSubmit();"
                                    autocomplete="off">
                                    @csrf
                                    @include('pages.cotizaciones.form_crear')
                                </form>
                            </div>
                        </div>
                    </div>
