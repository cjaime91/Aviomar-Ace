...
@section('titulo')
    Cotizaciones Agente Importación
@endsection
...
@section('scripts')
    ...
    <script>
        var tabla_impo = $('#tcimpo').DataTable({
            ordering: true,
	    order: [[2, 'asc']],
            buttons: [{
                    "extend": "copy",
            ...
            scrollY: "300px",
            serverSide: true,
            ajax: "{{ url('api/cotizaciones_impo') }}",
            lengthMenu: [
                [8, 10, 25, 50, 100, -1],
                [8, 10, 25, 50, 100, "All"]
            ],
            columns: [{
                    data: "consecutivo_impo",
                    "sClass": "center"
                },
                {
                    data: "cliente",
        ...
        $('#tcimpo tbody').on('click', 'td.details-control', function() {
            var tr = $(this).closest('tr');
            var row = tabla_impo.row(tr);
            format(row.data());
        });

        function format(d) {
            $('.cmn').html(d.consecutivo_impo);
            $('.tcot').html('Cotización Agente Importación: ');
            if (d.cot_id != null) {
                $('#cot_id').val(d.cot_id);
    ...
    <script src="{{ asset('assets/js/data_cotizacion_impo.js') }}" type="text/javascript"></script>
@endsection
                ...
                <div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-3">
                    <div class="widget-box widget-color-orange" id="widget-box-3">
                        <div class="widget-header widget-header-small">
                            <h2 class="widget-title">Cotizaciones Agentes Importación</h4>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div id="tmn col-sm-12">
                                    <div class="row">
                                        <table id="tcimpo" class="table table-sm table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th
