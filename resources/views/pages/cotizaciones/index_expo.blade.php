...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/data_cotizacion_expo.js') }}" type="text/javascript"></script>
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
    <script>
        var tabla_expo = $('#tcexpo').DataTable({
            ordering: true,
	    order: [[2, 'asc']],
            buttons: [{
                    "extend": "copy",
            ...
            scrollY: "300px",
            serverSide: true,
            ajax: "{{ url('api/cotizaciones_expo') }}",
            columns: [{
                    data: "consecutivo_expo",
                    "sClass": "center"
                },
                {
                    data: "cliente",
        ...
        $('#tcexpo tbody').on('click', 'td.details-control', function() {
            var tr = $(this).closest('tr');
            var row = tabla_expo.row(tr);
            format(row.data());
        });

        function format(d) {
            $('.cmn').html(d.consecutivo_expo);
            $('.tcot').html('Cotización Agente Exportación: ');
            if (d.cot_id != null) {
                $('#cot_id').val(d.cot_id);
                $('#enlace').attr('href', "http://186.29.91.156/Aviomar-Ace/public/pages/cotizaciones/" + d.cot_id +
                    "/editar");
                /*$('#enlace').attr('href', "http://192.168.0.10/Aviomar-Ace/public/pages/cotizaciones/" + d.cot_id +
                    "/editar");*/
                ...
                switch (d.estado_id) {
                    ...
                    default:
                        ...
                        /*$('#form-act_est').attr('action', "http://192.168.0.10/Aviomar-Ace/public/pages/cotizaciones/a/" + d
                            .cot_id);*/
                        break;
                }
            };
            ...
            $.ajax({
                ...
                success: function(response) {
                    $.each(response.data, function(key, value) {
                        ...
                        $('#datos_n').append('<tr><td>' + value.usuario_com_id + '</td>' +
                ...
                <div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-3">
                    <div class="widget-box widget-color-orange" id="widget-box-3">
                        <div class="widget-header widget-header-small">
                            <h2 class="widget-title">Cotizaciones Agentes Exportación</h2>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div id="tmn col-sm-12">
                                    <div class="row">
                                        <table id="tcexpo" class="table table-sm table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select class="form-control select2bs4 input-sm"
                                                            style="width: 100%;" id="ejecutivo" name="ejecutivo">
                                                            <option value="">---</option>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select class="form-control select2bs4 input-sm"
                                                            style="width: 100%;" id="realizado" name="realizado">
                                                            <option value="">---</option>
                                                            @foreach ($users as $user)
                                                                <option value="{{ $user->id }}">
                                                                    {{ $user->full_name }}
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select class="form-control select2bs4 input-sm"
                                                            style="width: 100%;" id="est" name="est">
                                                            <option value="">---</option>
