$(document).ready(function() {
    var tabla_expo1 = $('#tcexpo').DataTable();
    tabla_expo1.buttons().container().appendTo($('.tableTools-container1'));
    ...
    $('#tcli').on('change', function() {
        if ($('#tcli option:selected').text() == '--Seleccione--') {
            tabla_expo1
                .columns(4)
                .search("")
                .draw();
    ...
    $('#ejecutivo').on('change', function() {
        if ($('#ejecutivo option:selected').text() == '--Seleccione--') {
            tabla_expo1
                .columns(6)
                .search("")
                .draw();
    ...
    $('#realizado').on('change', function() {
        if ($('#realizado option:selected').text() == '--Seleccione--') {
            tabla_expo1
                .columns(7)
                .search("")
                .draw();
